    ...
    export default {
        ...
        methods: {
            getProjectFromTaskId: function(task_id){
                ...
                if(task.project_id){
                    return this.$store.getters['projects/getProjectById'](task.project_id).acronym;
                } else {
                    return {};
                }
            },
            ...
            log: function(evt) {
              ...
              if(evt.added){
                  ...
                  this.$store.commit('tasks/updateUserTaskAttribute', {id: evt.added.element.id, attribute: this.attribute, value: this.attribute_value});
                  this.$store.dispatch('tasks/addToUserList', {id: evt.added.element.id, sort_order: evt.added.newIndex, attribute: this.attribute, value: this.attribute_value});
              } else if(evt.removed){
                  
              } else if(evt.moved){
                  this.$store.dispatch('tasks/addToUserList', {id: evt.moved.element.id, sort_order: evt.moved.newIndex, attribute: this.attribute, value: this.attribute_value});
              }
            },
            removeAt(idx) {
