...
import {ITask} from "../lists/types";
import {IProject} from "../projects/types";
import {FETCH_TASKS, SET_ALL_TASKS} from "../lists/mutations-types";
const state = {
    projects: [],
    lookup: {}
};
const mutations = {
    load(state: IModuleState, projects) {
...
const actions = {
    add(context, project): Promise<IProject> {
