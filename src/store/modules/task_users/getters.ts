    ...
    return state.task_users
      ...
      .map(
        ({
          ...
          const project_id = allTasks[lookup[task_id]]
            ? allTasks[lookup[task_id]].project_id
            : null
          const project = project_id
            ? projects[projectsLookup[allTasks[lookup[task_id]].project_id]]
            : null
          ...
          return {
            id,
            task_id,
            title: allTasks[lookup[task_id]]
              ? allTasks[lookup[task_id]].title
              : '',
            company_user_id,
            project_id,
            sort_order,
